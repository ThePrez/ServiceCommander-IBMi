...
You can install the binary distribution by copying the link to the `.rpm` file from the releases page of this project and using `yum` to install it. For instance, to install the v0.2.0 release:
```
yum install https://github.com/ThePrez/ServiceCommander-IBMi/releases/download/v0.2.0/sc-0.2.0-0.ibmi7.2.ppc64.rpm
```
