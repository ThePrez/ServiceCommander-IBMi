...
public class SCException extends Exception {
    ...
    public enum FailureType {
        ERROR_EXECUTING_STARTUP_CMD, GENERAL_ERROR, UNSUPPORTED_OPERATION, TIMEOUT_ON_SERVICE_STARTUP, MISSING_SERVICE_DEF, ERROR_CHECKING_STATUS, INVALID_SERVICE_CONFIG, ERROR_STARTING_DEPENDENCY, TIMEOUT_ON_SERVICE_STOP, ERROR_STOPPING_DEPENDENT
    }
